...
function App() {
  ...
  /**
   * ✨Consider using an active box index instead of four booleans. This index can be a number or null.
   * Update the code to replace all boolean usages with the active box index.
   */
